...
if(isset($_POST["login_button"])){
	...
	if($message == ''){
		$data = array(':user_email_address'	=>	$formdata['user_email_address']);
...
<div class="p-5 mb-4 bg-light rounded-3" style="min-height:600px">

<div class="row">
	<div class="col-md-6 " style="height:100%;">
		<img class="img-fluid" src="https://images.unsplash.com/photo-1521587760476-6c12a4b040da?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="">
	</div>
